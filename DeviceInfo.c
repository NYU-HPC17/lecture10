 ...
 *          Update by Georg Stadler, April 2015
*/
...
int main(void)
{
    ...
    CHECK_CL_ERROR(err, "Finding platforms");
    if (num_platforms == 0)
    {
    ...
    CHECK_CL_ERROR(err, "Getting platforms");
    ...
    for (int i = 0; i < num_platforms; i++)
    {
        ...
        for (int j = 0; j < num_devices; j++)
        {
            ...
            CHECK_CL_ERROR(err, "Getting device max work-group size");
            ...
            CHECK_CL_ERROR(err, "Getting device max work-item dims");
            ...
            CHECK_CL_ERROR(err, "Getting device max work-item sizes");
